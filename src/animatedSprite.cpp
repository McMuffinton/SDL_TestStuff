...
animatedSprite::animatedSprite(string imagePath, uint8_t R, uint8_t G, uint8_t B, int src_x, int src_y, int src_width,
                               int src_height, int totalSprites, int framesPerSprite[])
    : Sprite(imagePath, R, G, B, src_x, src_y, src_width, src_height) {
